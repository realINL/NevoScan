...
/**
 * ориентация `.up`, альфа на белый фон, `ARGB_8888`.
 */
...
/**
 * PIL/torchvision bilinear: `src = (dst + 0.5) * scale - 0.5`, RGB NCHW 0…1.
 */
...
/**
 * Маска 256→8 для классификатора: `srcY = y * 32`, `srcX = x * 32`.
 */
